...
const HeroSection: React.FC = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-coffee-50 via-cream-50 to-coffee-100">
      ...
      <div className="absolute inset-0 z-0">
        <img alt="Premium coffee beans" src="/lovable-uploads/2fc8b77b-692c-4535-b45a-309b30d4c060.png" className="w-full h-full object-cover opacity-70" />
      </div>

      {/* Animated Steam Effects */}
      <div className="absolute top-1/4 left-1/4 w-32 h-32 opacity-30">
        <div className="animate-steam bg-white rounded-full blur-sm w-4 h-4 absolute" style={{
        animationDelay: '0s'
      }}></div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button variant="outline" size="lg" className="border-coffee-600 text-coffee-600 hover:bg-coffee-600 hover:text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-200">
